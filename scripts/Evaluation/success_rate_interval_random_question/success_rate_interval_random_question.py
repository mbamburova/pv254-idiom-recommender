...
def success_rate_interval_random_question():
    data = pd.read_csv('user_answers_random_question.csv', sep=';')
    ...
    ax.set_title("Interval success rate for random questions", size = 50)
    ...
    fig.savefig("./success_rate_interval_random_question.pdf")

success_rate_interval_random_question()
